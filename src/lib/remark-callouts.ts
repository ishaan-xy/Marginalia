...
function iconSvg(type: string): string {
  ...
  // stroke-width 1.75 — matches the standardized stroke-width across all
  // decorative SVGs in the codebase (was previously 2).
  return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="${path}"/></svg>`;
}
